...
For recurring services, I discovered the provider was suddenly processed as *out of network*. When I reached out to fix the discrepancy, I was told:

* It will take **30 days** to reprocess
...
**AI is already being used in insurance. Just not for us.**

Today, AI helps insurers:

* Optimize denials
* Predict which claims are least likely to be appealed
* Automate prior authorizations that quietly fail
* Scale “Delay. Deny. Defend.” at machine speed

That’s AI *against* people.
...
One example is **Lemonade Insurance**, which rethought incentives from the ground up:

* Flat-fee models instead of denial-driven profit
* Faster, transparent claims
* Alignment between company success and customer outcomes
...
I refuse to accept that this is “just how insurance works.”
...
So what if we stopped playing defense?

- - -

### From hidden friction → public accountability

One of the most powerful levers we don’t use today is **transparency**—and the absence of it overwhelmingly benefits insurers, not patients or providers.

ClaimGo explores a future where we **measure and expose friction**, not hide it.

Imagine:

* A **Claim Friction Index** that reflects how hard it actually is to get paid
* A **Denial Risk Score** that predicts the likelihood a valid claim will be rejected
* Scores based on *real behavior*, not marketing promises

Not to shame—but to **create accountability**.

Because once friction is visible, incentives change.

- - -

### Employers as a force for good
...
### This is where AI must stand

Today, AI is often used **against** people:

* To automate denials
* To optimize claim attrition
* To scale Delay. Deny. Defend

But AI could do the opposite.

AI could:

* Anticipate requirement changes before they hurt providers
* Flag denial patterns early
* Reduce administrative burden instead of amplifying it
* Help families, providers, and employers make informed decisions

This is AI **working with humans—not against them**.
...
And with modern technology—including AI—we finally have the tools to build them.

Now we just need the courage to aim them in the right direction.
